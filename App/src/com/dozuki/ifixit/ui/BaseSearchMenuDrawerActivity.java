...
//            ((EditText) item.getActionView().findViewById(R.id.search_src_text)).setHint(hint);
//
...
//      MenuItemCompat.getActionView(barcodeItem).setOnClickListener(new OnClickListener() {
//         @Override
